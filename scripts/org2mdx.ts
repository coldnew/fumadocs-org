...
async function main() {
  ...
  if (args.length === 0) {
    console.log('Usage: tsx scripts/org2mdx.ts <mdx-file> [output-org-file]');
    console.log('Examples:');
    console.log('  tsx scripts/org2mdx.ts content/docs/example.mdx');
    console.log('  tsx scripts/org2mdx.ts content/docs/example.mdx output.org');
    process.exit(1);
  }
